...
export const mutationProblemDetailsSchema = z.discriminatedUnion('__typename', [
  validationProblemDetailsSchema,
  generalProblemDetailsSchema,
]);
...
export const mutationProblemSchema = z.discriminatedUnion('__typename', [
