import type { Container, ContainerConnection, CreateEntityInput, CreateEntityPayload, CreateEventInput, Event, GetEntityInput, ListContainersInput, ListOutersInput, Outer, OuterConnection } from '../../generated/graphql';
